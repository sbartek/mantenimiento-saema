...
RSpec.describe FabricantesController, :type => :controller do
  ...
  describe "GET index" do
    it "assigns all fabricantes as @fabricantes" do
      ...
      expect(assigns(:fabricantes)).to eq([fabricante])
    end
  end
  ...
  describe "GET show" do
    it "assigns the requested fabricante as @fabricante" do
      ...
      expect(assigns(:fabricante)).to eq(fabricante)
    end
  end
  ...
  describe "GET new" do
    it "assigns a new fabricante as @fabricante" do
      ...
      expect(assigns(:fabricante)).to be_a_new(Fabricante)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created fabricante as @fabricante" do
        post :create, {:fabricante => valid_attributes}, valid_session
        expect(assigns(:fabricante)).to be_a(Fabricante)
        expect(assigns(:fabricante)).to be_persisted
      end

      it "redirects to the created fabricante" do
        post :create, {:fabricante => valid_attributes}, valid_session
        expect(response).to redirect_to(Fabricante.last)
      end
    end

    describe "with invalid params" do
      it "assigns a newly created but unsaved fabricante as @fabricante" do
        post :create, {:fabricante => invalid_attributes}, valid_session
        expect(assigns(:fabricante)).to be_a_new(Fabricante)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested fabricante" do
        fabricante = Fabricante.create! valid_attributes
        put :update, {:id => fabricante.to_param, :fabricante => new_attributes}, valid_session
        fabricante.reload
      ...
      it "redirects to the fabricante" do
        fabricante = Fabricante.create! valid_attributes
        put :update, {:id => fabricante.to_param, :fabricante => valid_attributes}, valid_session
        expect(response).to redirect_to(fabricante)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the fabricante as @fabricante" do
        fabricante = Fabricante.create! valid_attributes
        put :update, {:id => fabricante.to_param, :fabricante => invalid_attributes}, valid_session
        expect(assigns(:fabricante)).to eq(fabricante)
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the fabricantes list" do
      fabricante = Fabricante.create! valid_attributes
      delete :destroy, {:id => fabricante.to_param}, valid_session
      expect(response).to redirect_to(fabricantes_url)
    end
  end
